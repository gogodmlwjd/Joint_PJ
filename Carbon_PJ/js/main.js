...
window.addEventListener("DOMContentLoaded",
    function () {
        ...
        // for문으로 글자만큼 li 만들기!! 
        // for of문 - 배열, 요소 컬렉션, 문자열데이터를 그 갯수만큼 자동으로 돈다~~! 
        // for of문의 지역변수는 그 데이터나 요소 자체임!
        for (var x of mtxt1) {
            if (x === " ") x = "&nbsp;" //공백문자 빈값에 넣기(공백문자가 들어가면서 디자인이 먹히게 됨)
        ...
        // 요소의 수만큼 for문셋팅하기
        // for of문 (선택된 요소만큼 반복함!) - of뒤에 쓴 변수!
...
$(window).scroll(function () {
    ...
    else if(scTop > 100 && scTop < 400){
        $(".mtit1").css({left:"-50%"});
        $(".mtit2").css({left:"-30%"});
    } //////// if /////////////////////
    else if(scTop > 100 && scTop < 500){
        $(".mtit1").css({left:"-80%"});
        $(".mtit2").css({left:"-50%"});
    } //////// if /////////////////////
    else if(scTop > 100 && scTop < 600){
        $(".mtit1").css({left:"-120%"});
        $(".mtit2").css({left:"-100%"});
    } //////// if /////////////////////
